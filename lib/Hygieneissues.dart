...
class _HygieneissuesReportPageState extends State<HygieneissuesReportPage>
  ...
  Future<void> _fetchReports() async {
    try {
      ...
      // Center the map on the first report (if available).
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Title with Hygiene Issues Icon and Text.
            Row(
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(
                  context: context,
                  delegate: HygieneissuesReportSearchDelegate(reports: _reports),
                );
              },
            ),
          ],
