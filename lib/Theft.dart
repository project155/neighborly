...
class TheftReportPage extends StatefulWidget {
  @override
  _TheftReportPageState createState() => _TheftReportPageState();
}
        ...
        if (report['location'] != null) {
          ...
          _markers.add(
            Marker(
              ...
              // Using a red marker hue for theft reports.
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Icon(Icons.lock, size: 30, color: Colors.redAccent),
                SizedBox(width: 8),
                Text(
                  "Theft Reports",
                  style: TextStyle(
...
// Custom SearchDelegate for theft reports.
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    TheftReportDetailPage(report: report),
              ),
            );
          },
        );
...
// Detail page for a theft report.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(report['title'] ?? "Theft Report Details"),
      ),
