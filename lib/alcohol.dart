...
class AlcoholReportPage extends StatefulWidget {
  @override
  _AlcoholReportPageState createState() => _AlcoholReportPageState();
}

class _AlcoholReportPageState extends State<AlcoholReportPage>
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Title with Alcohol Icon and Text.
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.local_bar, size: 30, color: Colors.redAccent),
                SizedBox(width: 8),
                Text(
                  "Alcohol Reports",
                  style: TextStyle(
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Icon(Icons.local_bar, color: Colors.redAccent),
