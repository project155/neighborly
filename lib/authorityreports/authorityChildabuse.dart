...
class ChildAbuseReportClonePage extends StatefulWidget {
  @override
  _ChildAbuseReportClonePageState createState() => _ChildAbuseReportClonePageState();
}

class _ChildAbuseReportClonePageState extends State<ChildAbuseReportClonePage>
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Icon(Icons.child_friendly, size: 30, color: Colors.red),
                SizedBox(width: 8),
                Text(
                  "Child Abuse Reports",
                  style: TextStyle(
          ...
          children: widget.imageUrls.asMap().entries.map((entry) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _current == entry.key ? Colors.red : Colors.grey.shade400,
              ),
            );
          }).toList(),
        ),
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Icon(Icons.child_friendly, color: Colors.red),
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ChildAbuseReportDetailPage(report: report)),
            );
          },
        );
      },
