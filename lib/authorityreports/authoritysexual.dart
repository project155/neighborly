...
class SexualAbuseReportClonePage extends StatefulWidget {
  @override
  _SexualAbuseReportClonePageState createState() => _SexualAbuseReportClonePageState();
}

class _SexualAbuseReportClonePageState extends State<SexualAbuseReportClonePage>
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                SizedBox(width: 8),
                Text("Sexual Abuse Reports", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black87)),
              ],
            ),
            IconButton(
              icon: Icon(Icons.search, color: Colors.black87),
              onPressed: () {
                showSearch(context: context, delegate: SexualAbuseReportSearchDelegate(reports: _reports));
              },
            ),
          ],
        ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("Urgency: $urgency", style: TextStyle(color: Colors.purple)),
                                          ],
                                        ),
...
class UploaderDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Uploader Details"), backgroundColor: Colors.purple),
        ...
        Row(
          ...
          children: widget.imageUrls.asMap().entries.map((entry) {
            return Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, color: _current == entry.key ? Colors.purple : Colors.grey.shade400),
            );
          }).toList(),
        ),
      ],
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          onTap: () {
            close(context, null);
            Navigator.push(context, MaterialPageRoute(builder: (context) => SexualAbuseReportDetailPage(report: report)));
          },
        );
      },
    );
...
class SexualAbuseReportDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.purple, title: Text(report['title'] ?? "Report Details")),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SizedBox(height: 5),
              Text("Urgency: ${report['urgency'] ?? "Normal"}", style: TextStyle(fontSize: 16, color: Colors.purple)),
            ]),
          )
        ]),
      ),
