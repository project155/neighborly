...
class TheftReportClonePage extends StatefulWidget {
  @override
  _TheftReportClonePageState createState() => _TheftReportClonePageState();
}

class _TheftReportClonePageState extends State<TheftReportClonePage>
  ...
  Future<void> _fetchReports() async {
    try {
      ...
      var snapshot = await _firestore
          .collection('reports')
          .where('category', isEqualTo: 'Theft')
  ...
  void _showComments(BuildContext context, String docId) {
    ...
    List<dynamic> comments =
        reportIndex != -1 ? List.from(_reports[reportIndex]['comments'] ?? []) : [];
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Title with Theft Icon.
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.security, size: 30, color: Colors.deepPurple),
                SizedBox(width: 8),
                Text(
                  "Theft Reports",
                  style: TextStyle(
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(
                  context: context,
                  delegate: TheftReportSearchDelegate(reports: _reports),
                );
              },
            ),
          ],
          ...
          children: widget.imageUrls.asMap().entries.map((entry) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                color: _current == entry.key ? Colors.deepPurple : Colors.grey.shade400,
              ),
            );
          }).toList(),
        ),
...
class TheftReportSearchDelegate extends SearchDelegate {
  final List<Map<String, dynamic>> reports;
  TheftReportSearchDelegate({required this.reports});
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => TheftReportDetailPage(report: report)),
            );
          },
        );
      },
...
class TheftReportDetailPage extends StatelessWidget {
  final Map<String, dynamic> report;
  TheftReportDetailPage({required this.report});
