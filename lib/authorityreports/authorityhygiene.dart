...
class HygieneIssuesReportClonePage extends StatefulWidget {
  @override
  _HygieneIssuesReportClonePageState createState() => _HygieneIssuesReportClonePageState();
}

class _HygieneIssuesReportClonePageState extends State<HygieneIssuesReportClonePage>
  ...
  Future<void> _fetchReports() async {
    try {
      ...
      // Fetch all 'hygiene issues' reports.
        ...
        child: Material(
          ...
          child: SlideTransition(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.clean_hands, color: Colors.white),
                  SizedBox(width: 8),
                  Expanded(
                    child: Text(
                      message,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Title with Hygiene Issues Icon.
            Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("Urgency: $urgency", style: TextStyle(color: Colors.teal)),
                                          ],
                                        ),
...
// Custom SearchDelegate for hygiene issues reports.
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => HygieneIssuesReportDetailPage(report: report)),
            );
          },
        );
      },
...
// Detail page for a hygiene issues report.
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text("Urgency: ${report['urgency'] ?? "Normal"}", style: TextStyle(fontSize: 16, color: Colors.teal)),
                ],
              ),
            )
          ],
