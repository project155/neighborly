...
class FireReportClonePage extends StatefulWidget {
  @override
  _FireReportClonePageState createState() => _FireReportClonePageState();
}

class _FireReportClonePageState extends State<FireReportClonePage>
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(
                  context: context,
                  delegate: FireReportSearchDelegate(reports: _reports),
                );
              },
            ),
          ],
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            // New uploader details button.
                                            IconButton(
                                              icon: Icon(Icons.person,
                                                  color: Colors.green),
                                              onPressed: () {
                                                _viewUploaderDetails(
                                                    uploaderUid);
                                              },
                                              tooltip:
...
// Custom SearchDelegate for fire reports.
class FireReportSearchDelegate extends SearchDelegate {
  final List<Map<String, dynamic>> reports;

  FireReportSearchDelegate({required this.reports});
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    FireReportDetailPage(report: report),
              ),
            );
          },
        );
...
// Detail page for a fire report.
class FireReportDetailPage extends StatelessWidget {
  final Map<String, dynamic> report;

  FireReportDetailPage({required this.report});
