...
class BriberyReportClonePage extends StatefulWidget {
  @override
  _BriberyReportClonePageState createState() => _BriberyReportClonePageState();
}

class _BriberyReportClonePageState extends State<BriberyReportClonePage>
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Icon(Icons.monetization_on, color: Colors.deepOrangeAccent),
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => BriberyReportDetailPage(report: report),
              ),
            );
          },
        );
