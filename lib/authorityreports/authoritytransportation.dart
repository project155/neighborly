...
class TransportationReportClonePage extends StatefulWidget {
  @override
  _TransportationReportClonePageState createState() => _TransportationReportClonePageState();
}

class _TransportationReportClonePageState extends State<TransportationReportClonePage>
        ...
        child: Row(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Icon(Icons.directions_bus, size: 30, color: Colors.indigoAccent),
                SizedBox(width: 8),
                Text(
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(context: context, delegate: TransportationReportSearchDelegate(reports: _reports));
              },
            ),
          ],
        ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text("Urgency: $urgency", style: TextStyle(color: Colors.indigoAccent)),
                                          ],
                                        ),
...
// Custom SearchDelegate for transportation reports.
class TransportationReportSearchDelegate extends SearchDelegate {
  final List<Map<String, dynamic>> reports;

  TransportationReportSearchDelegate({required this.reports});
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Icon(Icons.directions_bus, color: Colors.indigoAccent),
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => TransportationReportDetailPage(report: report)),
            );
          },
        );
      },
...
// Detail page for a transportation report.
class TransportationReportDetailPage extends StatelessWidget {
  final Map<String, dynamic> report;
  TransportationReportDetailPage({required this.report});
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 5),
                  Text("Urgency: ${report['urgency'] ?? "Normal"}", style: TextStyle(fontSize: 16, color: Colors.indigoAccent)),
                ],
              ),
            )
          ],
