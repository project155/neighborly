...
class LandslideReportClonePage extends StatefulWidget {
  @override
  _LandslideReportClonePageState createState() => _LandslideReportClonePageState();
}

class _LandslideReportClonePageState extends State<LandslideReportClonePage>
  ...
  Widget buildResults(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          leading: Icon(Icons.terrain, color: Colors.orangeAccent),
...
// Detail page for a landslide report.
