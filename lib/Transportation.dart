...
class TransportationReportPage extends StatefulWidget {
  @override
  _TransportationReportPageState createState() => _TransportationReportPageState();
}

class _TransportationReportPageState extends State<TransportationReportPage>
        ...
        if (report['location'] != null) {
          ...
          _markers.add(
            Marker(
              ...
              // Using a green marker hue for transportation reports.
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            // Title with Transportation Icon.
            Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.directions_bus, size: 30, color: Colors.teal),
                SizedBox(width: 8),
                Text(
            ...
            IconButton(
              ...
              onPressed: () {
                showSearch(
                  context: context,
                  delegate: TransportationReportSearchDelegate(reports: _reports),
                );
              },
            ),
          ],
        ...
        return ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => TransportationReportDetailPage(report: report),
              ),
            );
          },
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(report['title'] ?? "Transportation Report Details"),
      ),
